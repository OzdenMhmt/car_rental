...
public class User implements Serializable {
    ...
    @Column(nullable = false, length = 15) //database elle girdigimiz zamanlardada null kabul etmesin diye double kontrol
    private String city;
    ...
    @ManyToMany(fetch = FetchType.LAZY) //bunlar cok onemli
    @JoinTable(name = "user_roles",
            joinColumns = @JoinColumn(name = "user_id"),
            inverseJoinColumns = @JoinColumn(name = "role_id"))
    private Set <Role> roles = new HashSet<>(); //rollerimizin bilgisini tutuyor
